...
MIDDLEWARE = [
    ...
    'django_prometheus.middleware.PrometheusAfterMiddleware',  # MUST BE ON BOTTOM
]
...
# Added auth JTW -> Session(for admin page)
REST_FRAMEWORK = {
...
# NOTE: the duration is like that bc no real app.
SIMPLE_JWT = {
